...
> = {
  ...
  meta: {
    modelProps: 'user' | 'groupChat' | 'groupUser' | 'chat';
    ...
    GroupChat: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.GroupChatCountAggregateOutputType>
            | number;
        };
      };
    };
    GroupUser: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.GroupUserCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type GroupChatScalarFieldEnum =
  (typeof GroupChatScalarFieldEnum)[keyof typeof GroupChatScalarFieldEnum];
...
export type GroupUserScalarFieldEnum =
  (typeof GroupUserScalarFieldEnum)[keyof typeof GroupUserScalarFieldEnum];
