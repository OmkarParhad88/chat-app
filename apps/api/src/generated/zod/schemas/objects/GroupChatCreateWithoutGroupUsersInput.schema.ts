...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatCreateWithoutGroupUsersInputObjectSchema: z.ZodType<Prisma.GroupChatCreateWithoutGroupUsersInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatCreateWithoutGroupUsersInput>;
export const GroupChatCreateWithoutGroupUsersInputObjectZodSchema =
  makeSchema();
