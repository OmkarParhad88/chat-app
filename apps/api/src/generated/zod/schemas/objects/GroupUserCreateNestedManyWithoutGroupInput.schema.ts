...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupUserCreateNestedManyWithoutGroupInputObjectSchema: z.ZodType<Prisma.GroupUserCreateNestedManyWithoutGroupInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupUserCreateNestedManyWithoutGroupInput>;
export const GroupUserCreateNestedManyWithoutGroupInputObjectZodSchema =
  makeSchema();
