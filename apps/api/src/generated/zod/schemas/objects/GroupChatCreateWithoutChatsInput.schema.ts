...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatCreateWithoutChatsInputObjectSchema: z.ZodType<Prisma.GroupChatCreateWithoutChatsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatCreateWithoutChatsInput>;
