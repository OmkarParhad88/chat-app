  ...
  z
    .object({
      ...
      group: z
        .lazy(
          () =>
            GroupChatUpdateOneRequiredWithoutGroupUsersNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();
export const GroupUserUpdateInputObjectSchema: z.ZodType<Prisma.GroupUserUpdateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupUserUpdateInput>;
