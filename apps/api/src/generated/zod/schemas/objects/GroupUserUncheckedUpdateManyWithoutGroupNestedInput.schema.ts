  ...
  z
    .object({
      ...
      upsert: z
        .union([
          z.lazy(
            () => GroupUserUpsertWithWhereUniqueWithoutGroupInputObjectSchema,
          ),
          z
            .lazy(
              () => GroupUserUpsertWithWhereUniqueWithoutGroupInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => GroupUserUpdateWithWhereUniqueWithoutGroupInputObjectSchema,
          ),
          z
            .lazy(
              () => GroupUserUpdateWithWhereUniqueWithoutGroupInputObjectSchema,
      ...
      updateMany: z
        .union([
          z.lazy(
            () => GroupUserUpdateManyWithWhereWithoutGroupInputObjectSchema,
          ),
          z
            .lazy(
              () => GroupUserUpdateManyWithWhereWithoutGroupInputObjectSchema,
    ...
    .strict();
export const GroupUserUncheckedUpdateManyWithoutGroupNestedInputObjectSchema: z.ZodType<Prisma.GroupUserUncheckedUpdateManyWithoutGroupNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupUserUncheckedUpdateManyWithoutGroupNestedInput>;
export const GroupUserUncheckedUpdateManyWithoutGroupNestedInputObjectZodSchema =
  makeSchema();
