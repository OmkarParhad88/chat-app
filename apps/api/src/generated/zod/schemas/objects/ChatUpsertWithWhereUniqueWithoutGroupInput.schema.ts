...
const makeSchema = () => z.object({
  ...
  update: z.union([z.lazy(() => ChatUpdateWithoutGroupInputObjectSchema), z.lazy(() => ChatUncheckedUpdateWithoutGroupInputObjectSchema)]),
  create: z.union([z.lazy(() => ChatCreateWithoutGroupInputObjectSchema), z.lazy(() => ChatUncheckedCreateWithoutGroupInputObjectSchema)])
}).strict();
export const ChatUpsertWithWhereUniqueWithoutGroupInputObjectSchema: z.ZodType<Prisma.ChatUpsertWithWhereUniqueWithoutGroupInput> = makeSchema() as unknown as z.ZodType<Prisma.ChatUpsertWithWhereUniqueWithoutGroupInput>;
export const ChatUpsertWithWhereUniqueWithoutGroupInputObjectZodSchema = makeSchema();
