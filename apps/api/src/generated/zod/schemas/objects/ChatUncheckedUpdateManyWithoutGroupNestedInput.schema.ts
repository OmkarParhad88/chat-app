...
const makeSchema = () =>
  z
    .object({
      ...
      upsert: z
        .union([
          z.lazy(() => ChatUpsertWithWhereUniqueWithoutGroupInputObjectSchema),
          z
            .lazy(() => ChatUpsertWithWhereUniqueWithoutGroupInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => ChatUpdateWithWhereUniqueWithoutGroupInputObjectSchema),
          z
            .lazy(() => ChatUpdateWithWhereUniqueWithoutGroupInputObjectSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => ChatUpdateManyWithWhereWithoutGroupInputObjectSchema),
          z
            .lazy(() => ChatUpdateManyWithWhereWithoutGroupInputObjectSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
        .union([
          z.lazy(() => ChatScalarWhereInputObjectSchema),
          z.lazy(() => ChatScalarWhereInputObjectSchema).array(),
        ])
        .optional(),
    })
    .strict();
export const ChatUncheckedUpdateManyWithoutGroupNestedInputObjectSchema: z.ZodType<Prisma.ChatUncheckedUpdateManyWithoutGroupNestedInput> =
  makeSchema() as unknown as z.ZodType<Prisma.ChatUncheckedUpdateManyWithoutGroupNestedInput>;
export const ChatUncheckedUpdateManyWithoutGroupNestedInputObjectZodSchema =
  makeSchema();
