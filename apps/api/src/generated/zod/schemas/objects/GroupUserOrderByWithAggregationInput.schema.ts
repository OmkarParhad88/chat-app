...
const makeSchema = () => z.object({
  ...
  _count: z.lazy(() => GroupUserCountOrderByAggregateInputObjectSchema).optional(),
  _avg: z.lazy(() => GroupUserAvgOrderByAggregateInputObjectSchema).optional(),
  _max: z.lazy(() => GroupUserMaxOrderByAggregateInputObjectSchema).optional(),
  _min: z.lazy(() => GroupUserMinOrderByAggregateInputObjectSchema).optional(),
  _sum: z.lazy(() => GroupUserSumOrderByAggregateInputObjectSchema).optional()
}).strict();
export const GroupUserOrderByWithAggregationInputObjectSchema: z.ZodType<Prisma.GroupUserOrderByWithAggregationInput> = makeSchema() as unknown as z.ZodType<Prisma.GroupUserOrderByWithAggregationInput>;
