...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatCreateOrConnectWithoutUserInputObjectSchema: z.ZodType<Prisma.GroupChatCreateOrConnectWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatCreateOrConnectWithoutUserInput>;
export const GroupChatCreateOrConnectWithoutUserInputObjectZodSchema =
  makeSchema();
