...
const makeSchema = () => z.object({
  ...
  data: z.union([z.lazy(() => ChatUpdateManyMutationInputObjectSchema), z.lazy(() => ChatUncheckedUpdateManyWithoutGroupInputObjectSchema)])
}).strict();
export const ChatUpdateManyWithWhereWithoutGroupInputObjectSchema: z.ZodType<Prisma.ChatUpdateManyWithWhereWithoutGroupInput> = makeSchema() as unknown as z.ZodType<Prisma.ChatUpdateManyWithWhereWithoutGroupInput>;
export const ChatUpdateManyWithWhereWithoutGroupInputObjectZodSchema = makeSchema();
