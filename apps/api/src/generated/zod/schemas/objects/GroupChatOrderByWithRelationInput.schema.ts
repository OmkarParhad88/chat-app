...
const makeSchema = () =>
  z
    .object({
      ...
      Chats: z
        .lazy(() => ChatOrderByRelationAggregateInputObjectSchema)
        .optional(),
      GroupUsers: z
        .lazy(() => GroupUserOrderByRelationAggregateInputObjectSchema)
        .optional(),
    })
    .strict();
export const GroupChatOrderByWithRelationInputObjectSchema: z.ZodType<Prisma.GroupChatOrderByWithRelationInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatOrderByWithRelationInput>;
