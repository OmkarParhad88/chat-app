...
const makeSchema = () => z.object({
  ...
  update: z.union([z.lazy(() => GroupUserUpdateWithoutGroupInputObjectSchema), z.lazy(() => GroupUserUncheckedUpdateWithoutGroupInputObjectSchema)]),
  create: z.union([z.lazy(() => GroupUserCreateWithoutGroupInputObjectSchema), z.lazy(() => GroupUserUncheckedCreateWithoutGroupInputObjectSchema)])
}).strict();
export const GroupUserUpsertWithWhereUniqueWithoutGroupInputObjectSchema: z.ZodType<Prisma.GroupUserUpsertWithWhereUniqueWithoutGroupInput> = makeSchema() as unknown as z.ZodType<Prisma.GroupUserUpsertWithWhereUniqueWithoutGroupInput>;
export const GroupUserUpsertWithWhereUniqueWithoutGroupInputObjectZodSchema = makeSchema();
