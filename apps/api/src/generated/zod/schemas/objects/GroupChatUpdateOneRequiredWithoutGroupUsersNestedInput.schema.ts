...
const makeSchema = () => z.object({
  ...
  upsert: z.lazy(() => GroupChatUpsertWithoutGroupUsersInputObjectSchema).optional(),
  connect: z.lazy(() => GroupChatWhereUniqueInputObjectSchema).optional(),
  update: z.union([z.lazy(() => GroupChatUpdateToOneWithWhereWithoutGroupUsersInputObjectSchema), z.lazy(() => GroupChatUpdateWithoutGroupUsersInputObjectSchema), z.lazy(() => GroupChatUncheckedUpdateWithoutGroupUsersInputObjectSchema)]).optional()
}).strict();
export const GroupChatUpdateOneRequiredWithoutGroupUsersNestedInputObjectSchema: z.ZodType<Prisma.GroupChatUpdateOneRequiredWithoutGroupUsersNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.GroupChatUpdateOneRequiredWithoutGroupUsersNestedInput>;
export const GroupChatUpdateOneRequiredWithoutGroupUsersNestedInputObjectZodSchema = makeSchema();
