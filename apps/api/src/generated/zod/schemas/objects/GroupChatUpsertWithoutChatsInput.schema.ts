...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatUpsertWithoutChatsInputObjectSchema: z.ZodType<Prisma.GroupChatUpsertWithoutChatsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatUpsertWithoutChatsInput>;
