...
const makeSchema = () =>
  z
    .object({
      ...
      data: z.union([
        z.lazy(() => GroupUserUpdateManyMutationInputObjectSchema),
        z.lazy(() => GroupUserUncheckedUpdateManyWithoutGroupInputObjectSchema),
      ]),
    })
    .strict();
export const GroupUserUpdateManyWithWhereWithoutGroupInputObjectSchema: z.ZodType<Prisma.GroupUserUpdateManyWithWhereWithoutGroupInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupUserUpdateManyWithWhereWithoutGroupInput>;
export const GroupUserUpdateManyWithWhereWithoutGroupInputObjectZodSchema =
  makeSchema();
