...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatUncheckedCreateWithoutUserInputObjectSchema: z.ZodType<Prisma.GroupChatUncheckedCreateWithoutUserInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatUncheckedCreateWithoutUserInput>;
export const GroupChatUncheckedCreateWithoutUserInputObjectZodSchema =
  makeSchema();
