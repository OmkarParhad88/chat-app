...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatCreateOrConnectWithoutChatsInputObjectSchema: z.ZodType<Prisma.GroupChatCreateOrConnectWithoutChatsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatCreateOrConnectWithoutChatsInput>;
export const GroupChatCreateOrConnectWithoutChatsInputObjectZodSchema =
  makeSchema();
