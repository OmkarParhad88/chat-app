...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatUpsertWithoutGroupUsersInputObjectSchema: z.ZodType<Prisma.GroupChatUpsertWithoutGroupUsersInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatUpsertWithoutGroupUsersInput>;
export const GroupChatUpsertWithoutGroupUsersInputObjectZodSchema =
  makeSchema();
