...
const makeSchema = () => z.object({
  create: z.union([z.lazy(() => GroupChatCreateWithoutChatsInputObjectSchema), z.lazy(() => GroupChatUncheckedCreateWithoutChatsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => GroupChatCreateOrConnectWithoutChatsInputObjectSchema).optional(),
  upsert: z.lazy(() => GroupChatUpsertWithoutChatsInputObjectSchema).optional(),
  connect: z.lazy(() => GroupChatWhereUniqueInputObjectSchema).optional(),
  update: z.union([z.lazy(() => GroupChatUpdateToOneWithWhereWithoutChatsInputObjectSchema), z.lazy(() => GroupChatUpdateWithoutChatsInputObjectSchema), z.lazy(() => GroupChatUncheckedUpdateWithoutChatsInputObjectSchema)]).optional()
}).strict();
export const GroupChatUpdateOneRequiredWithoutChatsNestedInputObjectSchema: z.ZodType<Prisma.GroupChatUpdateOneRequiredWithoutChatsNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.GroupChatUpdateOneRequiredWithoutChatsNestedInput>;
export const GroupChatUpdateOneRequiredWithoutChatsNestedInputObjectZodSchema = makeSchema();
