...
const groupuserwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => GroupUserWhereInputObjectSchema), z.lazy(() => GroupUserWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => GroupUserWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => GroupUserWhereInputObjectSchema), z.lazy(() => GroupUserWhereInputObjectSchema).array()]).optional(),
...
export const GroupUserWhereInputObjectSchema: z.ZodType<Prisma.GroupUserWhereInput> = groupuserwhereinputSchema as unknown as z.ZodType<Prisma.GroupUserWhereInput>;
