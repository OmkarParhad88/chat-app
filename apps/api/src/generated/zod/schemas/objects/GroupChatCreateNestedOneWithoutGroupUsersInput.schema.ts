...
const makeSchema = () =>
  z
    ...
    .strict();
export const GroupChatCreateNestedOneWithoutGroupUsersInputObjectSchema: z.ZodType<Prisma.GroupChatCreateNestedOneWithoutGroupUsersInput> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatCreateNestedOneWithoutGroupUsersInput>;
export const GroupChatCreateNestedOneWithoutGroupUsersInputObjectZodSchema =
  makeSchema();
