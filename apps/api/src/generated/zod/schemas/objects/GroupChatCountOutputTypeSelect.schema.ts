  ...
  z
    .object({
      Chats: z
        .union([
          z.boolean(),
          z.lazy(() => GroupChatCountOutputTypeCountChatsArgsObjectSchema),
        ])
        .optional(),
      GroupUsers: z
        .union([
          z.boolean(),
          z.lazy(() => GroupChatCountOutputTypeCountGroupUsersArgsObjectSchema),
        ])
        .optional(),
    })
    .strict();
export const GroupChatCountOutputTypeSelectObjectSchema: z.ZodType<Prisma.GroupChatCountOutputTypeSelect> =
  makeSchema() as unknown as z.ZodType<Prisma.GroupChatCountOutputTypeSelect>;
