...
const makeSchema = () =>
  z
    ...
    .strict();
export const UserCreateNestedOneWithoutChatGroupsInputObjectSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutChatGroupsInput> =
  makeSchema() as unknown as z.ZodType<Prisma.UserCreateNestedOneWithoutChatGroupsInput>;
export const UserCreateNestedOneWithoutChatGroupsInputObjectZodSchema =
  makeSchema();
