...
const makeSchema = () =>
  z
    .object({
      ...
      group: z
        .lazy(
          () => GroupChatUpdateOneRequiredWithoutChatsNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();
export const ChatUpdateInputObjectSchema: z.ZodType<Prisma.ChatUpdateInput> =
  makeSchema() as unknown as z.ZodType<Prisma.ChatUpdateInput>;
