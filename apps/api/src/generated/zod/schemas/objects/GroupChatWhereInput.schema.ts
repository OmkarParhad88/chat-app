...
const groupchatwhereinputSchema = z
  .object({
    AND: z
      .union([
        z.lazy(() => GroupChatWhereInputObjectSchema),
        z.lazy(() => GroupChatWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => GroupChatWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
    ...
    title: z
      ...
      .optional(),
    passcode: z
      .union([z.lazy(() => StringFilterObjectSchema), z.string().max(20)])
      .optional(),
    created_at: z
    ...
    GroupUsers: z
      .lazy(() => GroupUserListRelationFilterObjectSchema)
      .optional(),
  })
  .strict();
export const GroupChatWhereInputObjectSchema: z.ZodType<Prisma.GroupChatWhereInput> =
  groupchatwhereinputSchema as unknown as z.ZodType<Prisma.GroupChatWhereInput>;
