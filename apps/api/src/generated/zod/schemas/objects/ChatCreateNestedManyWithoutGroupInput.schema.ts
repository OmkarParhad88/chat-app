...
const makeSchema = () =>
  z
    ...
    .strict();
export const ChatCreateNestedManyWithoutGroupInputObjectSchema: z.ZodType<Prisma.ChatCreateNestedManyWithoutGroupInput> =
  makeSchema() as unknown as z.ZodType<Prisma.ChatCreateNestedManyWithoutGroupInput>;
export const ChatCreateNestedManyWithoutGroupInputObjectZodSchema =
  makeSchema();
