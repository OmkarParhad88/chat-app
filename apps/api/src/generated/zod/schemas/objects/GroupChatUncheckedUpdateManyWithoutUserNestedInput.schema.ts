...
const makeSchema = () => z.object({
  ...
  upsert: z.union([z.lazy(() => GroupChatUpsertWithWhereUniqueWithoutUserInputObjectSchema), z.lazy(() => GroupChatUpsertWithWhereUniqueWithoutUserInputObjectSchema).array()]).optional(),
  createMany: z.lazy(() => GroupChatCreateManyUserInputEnvelopeObjectSchema).optional(),
  set: z.union([z.lazy(() => GroupChatWhereUniqueInputObjectSchema), z.lazy(() => GroupChatWhereUniqueInputObjectSchema).array()]).optional(),
  disconnect: z.union([z.lazy(() => GroupChatWhereUniqueInputObjectSchema), z.lazy(() => GroupChatWhereUniqueInputObjectSchema).array()]).optional(),
  delete: z.union([z.lazy(() => GroupChatWhereUniqueInputObjectSchema), z.lazy(() => GroupChatWhereUniqueInputObjectSchema).array()]).optional(),
  connect: z.union([z.lazy(() => GroupChatWhereUniqueInputObjectSchema), z.lazy(() => GroupChatWhereUniqueInputObjectSchema).array()]).optional(),
  update: z.union([z.lazy(() => GroupChatUpdateWithWhereUniqueWithoutUserInputObjectSchema), z.lazy(() => GroupChatUpdateWithWhereUniqueWithoutUserInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => GroupChatUpdateManyWithWhereWithoutUserInputObjectSchema), z.lazy(() => GroupChatUpdateManyWithWhereWithoutUserInputObjectSchema).array()]).optional(),
  deleteMany: z.union([z.lazy(() => GroupChatScalarWhereInputObjectSchema), z.lazy(() => GroupChatScalarWhereInputObjectSchema).array()]).optional()
}).strict();
export const GroupChatUncheckedUpdateManyWithoutUserNestedInputObjectSchema: z.ZodType<Prisma.GroupChatUncheckedUpdateManyWithoutUserNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.GroupChatUncheckedUpdateManyWithoutUserNestedInput>;
export const GroupChatUncheckedUpdateManyWithoutUserNestedInputObjectZodSchema = makeSchema();
