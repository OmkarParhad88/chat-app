...
export const GroupUserFindFirstSelectSchema: z.ZodType<Prisma.GroupUserSelect> = z.object({
...
export const GroupUserFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    group: z.boolean().optional(),
    group_id: z.boolean().optional(),
    name: z.boolean().optional(),
