...
export const GroupUserCountSchema: z.ZodType<Prisma.GroupUserCountArgs> = z
  .object({
    orderBy: z
      .union([
  ...
  .strict() as unknown as z.ZodType<Prisma.GroupUserCountArgs>;

export const GroupUserCountZodSchema = z
  .object({
    orderBy: z
      .union([
        GroupUserOrderByWithRelationInputObjectSchema,
