...
export const GroupChatCreateManySchema: z.ZodType<Prisma.GroupChatCreateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as unknown as z.ZodType<Prisma.GroupChatCreateManyArgs>;

export const GroupChatCreateManyZodSchema = z
  .object({
    data: z.union([
      GroupChatCreateManyInputObjectSchema,
      z.array(GroupChatCreateManyInputObjectSchema),
