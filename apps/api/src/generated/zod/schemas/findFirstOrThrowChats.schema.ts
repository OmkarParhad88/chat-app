...
export const ChatsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ChatsSelect> = z.object({
...
export const ChatsFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    group: z.boolean().optional(),
    group_id: z.boolean().optional(),
    message: z.boolean().optional(),
...
export const ChatsFindFirstOrThrowSchema: z.ZodType<Prisma.ChatsFindFirstOrThrowArgs> = z.object({ select: ChatsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ChatsIncludeObjectSchema.optional()), orderBy: z.union([ChatsOrderByWithRelationInputObjectSchema, ChatsOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChatsWhereInputObjectSchema.optional(), cursor: ChatsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChatsScalarFieldEnumSchema, ChatsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ChatsFindFirstOrThrowArgs>;

export const ChatsFindFirstOrThrowZodSchema = z.object({ select: ChatsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ChatsIncludeObjectSchema.optional()), orderBy: z.union([ChatsOrderByWithRelationInputObjectSchema, ChatsOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChatsWhereInputObjectSchema.optional(), cursor: ChatsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChatsScalarFieldEnumSchema, ChatsScalarFieldEnumSchema.array()]).optional() }).strict();