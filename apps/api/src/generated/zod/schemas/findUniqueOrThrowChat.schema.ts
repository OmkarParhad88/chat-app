...
export const ChatFindUniqueOrThrowSchema: z.ZodType<Prisma.ChatFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.ChatFindUniqueOrThrowArgs>;

export const ChatFindUniqueOrThrowZodSchema = z
  .object({
    select: ChatSelectObjectSchema.optional(),
    include: ChatIncludeObjectSchema.optional(),
    where: ChatWhereUniqueInputObjectSchema,
