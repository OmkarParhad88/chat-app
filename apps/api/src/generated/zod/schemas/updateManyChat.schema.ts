...
export const ChatUpdateManySchema: z.ZodType<Prisma.ChatUpdateManyArgs> = z
  .object({
    data: ChatUpdateManyMutationInputObjectSchema,
    where: ChatWhereInputObjectSchema.optional(),
  })
  .strict() as unknown as z.ZodType<Prisma.ChatUpdateManyArgs>;

export const ChatUpdateManyZodSchema = z
  .object({
    data: ChatUpdateManyMutationInputObjectSchema,
    where: ChatWhereInputObjectSchema.optional(),
  })
