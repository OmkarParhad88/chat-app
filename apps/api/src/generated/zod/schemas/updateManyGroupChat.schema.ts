...
export const GroupChatUpdateManySchema: z.ZodType<Prisma.GroupChatUpdateManyArgs> =
  z
    .object({
      data: GroupChatUpdateManyMutationInputObjectSchema,
      where: GroupChatWhereInputObjectSchema.optional(),
    })
    .strict() as unknown as z.ZodType<Prisma.GroupChatUpdateManyArgs>;

export const GroupChatUpdateManyZodSchema = z
  .object({
    data: GroupChatUpdateManyMutationInputObjectSchema,
    where: GroupChatWhereInputObjectSchema.optional(),
  })
