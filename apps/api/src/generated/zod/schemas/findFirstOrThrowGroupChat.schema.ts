...
export const GroupChatFindFirstOrThrowSelectSchema: z.ZodType<Prisma.GroupChatSelect> =
  z
    .object({
...
export const GroupChatFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    user: z.boolean().optional(),
    user_id: z.boolean().optional(),
...
export const GroupChatFindFirstOrThrowSchema: z.ZodType<Prisma.GroupChatFindFirstOrThrowArgs> =
  z
    .object({
      select: GroupChatFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.GroupChatFindFirstOrThrowArgs>;

export const GroupChatFindFirstOrThrowZodSchema = z
  .object({
    select: GroupChatFindFirstOrThrowSelectSchema.optional(),
    include: z.lazy(() => GroupChatIncludeObjectSchema.optional()),
    orderBy: z
