...
export const ChatFindManySelectSchema: z.ZodType<Prisma.ChatSelect> = z
  .object({
...
export const ChatFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    group: z.boolean().optional(),
    group_id: z.boolean().optional(),
...
export const ChatFindManySchema: z.ZodType<Prisma.ChatFindManyArgs> = z
  .object({
    select: ChatFindManySelectSchema.optional(),
  ...
  .strict() as unknown as z.ZodType<Prisma.ChatFindManyArgs>;

export const ChatFindManyZodSchema = z
  .object({
    select: ChatFindManySelectSchema.optional(),
    include: z.lazy(() => ChatIncludeObjectSchema.optional()),
    orderBy: z
