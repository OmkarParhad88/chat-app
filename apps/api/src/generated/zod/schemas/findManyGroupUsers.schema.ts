...
export const GroupUsersFindManySelectSchema: z.ZodType<Prisma.GroupUsersSelect> = z.object({
...
export const GroupUsersFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    group: z.boolean().optional(),
    group_id: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const GroupUsersFindManySchema: z.ZodType<Prisma.GroupUsersFindManyArgs> = z.object({ select: GroupUsersFindManySelectSchema.optional(), include: z.lazy(() => GroupUsersIncludeObjectSchema.optional()), orderBy: z.union([GroupUsersOrderByWithRelationInputObjectSchema, GroupUsersOrderByWithRelationInputObjectSchema.array()]).optional(), where: GroupUsersWhereInputObjectSchema.optional(), cursor: GroupUsersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GroupUsersScalarFieldEnumSchema, GroupUsersScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GroupUsersFindManyArgs>;

export const GroupUsersFindManyZodSchema = z.object({ select: GroupUsersFindManySelectSchema.optional(), include: z.lazy(() => GroupUsersIncludeObjectSchema.optional()), orderBy: z.union([GroupUsersOrderByWithRelationInputObjectSchema, GroupUsersOrderByWithRelationInputObjectSchema.array()]).optional(), where: GroupUsersWhereInputObjectSchema.optional(), cursor: GroupUsersWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GroupUsersScalarFieldEnumSchema, GroupUsersScalarFieldEnumSchema.array()]).optional() }).strict();